  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <main className="max-w-5xl mx-auto p-8 flex flex-col gap-6">
        ...
        <section className="flex flex-col gap-s">
          <h2 className="font-display text-xl text-body">Image Card</h2>
          <p className="font-body text-sm text-body">
            Bare with neither title nor description; hover or keyboard-focus the other two
            for the caption panel. The last one is also a link, so it picks up the same hover
            elevation as Card.
          </p>

          <div className="grid grid-cols-1 gap-s sm:grid-cols-3">
            <ImageCard src={heroImage} alt="A lioness resting on open gravel" />
            <ImageCard
              src={heroImage}
              alt="A lioness resting on open gravel"
              title="Build your own team library"
              description="Caption revealed on hover or keyboard focus."
            />
            <ImageCard
              src={heroImage}
              alt="A lioness resting on open gravel"
        ...
        <section className="flex flex-col gap-s">
          <h2 className="font-display text-xl text-body">NavLink</h2>
          <p className="font-body text-sm text-body">
            Hover or keyboard-focus a link for its remaining states. Active marks the current
            page — the one variant that has to be a prop, since no CSS pseudo-class knows which
        ...
        <section className="flex flex-col gap-s">
          <h2 className="font-display text-xl text-body">Tag</h2>
          <p className="font-body text-sm text-body">
            No State axis — a tag labels content rather than responding to it, so there is
            nothing to hover, focus or press.
          </p>

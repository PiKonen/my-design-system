    ...
    docs: {
      description: {
        component: [
          ...
          '',
          'Links are keyed by `href`, so entries must have distinct hrefs — three links all',
          "pointing at `'#'` (as on the App reference page) trigger a React duplicate-key",
          'warning. The stories here use real paths.',
        ].join('\n'),
      },
    },
  },

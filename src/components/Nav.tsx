...
//   padding    24px -> spacing/large (32px), the nearest step with the tie
//              rounding up, which is the convention the landing page documents
//   link gap   23px -> spacing/medium (16px). The design expressed this as a
//              fixed 169px row set to SPACE_BETWEEN; it is a real gap now
...
export function Nav({ siteName, links }: NavProps) {
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-grey-20 bg-white">
      <div className="mx-auto flex max-w-5xl items-center justify-between p-large">
